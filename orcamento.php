...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Somos especializados em lavagem e limpeza de sofás e estofados em geral. Nossa equipe comercial está à postos para tirar todas as suas dúvidas e realizar o seu orçamento.">
...
<body>
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex justify-content-between">
                        ...
                        <div class="top-contact-info d-flex align-items-center">
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="São Paulo, ABCD e Região"><img src="img/core-img/placeholder.png" alt="Lavagem e Limpeza de Sofás e Estofados, ligue: 11 964891638 | Decorlimp"> <span>São Paulo, ABCD e Região</span></a>
                            <a href="mailto: comercial@decorlimp.com.br" data-toggle="tooltip" data-placement="bottom" title="CLIQUE PARA SOLICITAR ORÇAMENTO"><img src="img/core-img/message.png" alt="Lavagem e Limpeza de Sofás e Estofados, ligue: 11 964891638 | Decorlimp"> <span>comercial@decorlimp.com.br</span></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#">Serviços</a>
                                        <div class="megamenu">
                                            <ul class="single-mega cn-col-4">
                                                ...
                                                <li><a href="servicos/automoveis.html">Automóveis</a></li>
                                    ...
                                    <li><a class="ativo" href="contact.php">Contato</a></li>
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
    ...
    <section class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/19.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
    ...
    <section class="contact-area section-padding-100-0">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="single-contact-area mb-100">
                        <!-- Logo -->
                        <a href="index.html" class="d-block mb-50"><img src="img/core-img/logo.png" alt="Decorlimp - Lavagem e Limpeza de Sofá e Estofados | Ligue: (11) 96489-1638"></a>
                        <p>Somos especialistas em lavagem e limpeza de sofás e estofados. Trabalhamos no conforto de sua residência ou empresa.</p>
                    </div>
                </div>
                        ...
                        <div class="contact--area contact-page">
                            ...
                            <div class="contact-content">
                                ...
                                <div class="single-contact-content d-flex align-items-center">
                                    <div class="icon">
                                        <img src="img/core-img/location.png" alt="Lavagem e Limpeza de Sofás e Estofados, ligue: 11 964891638 | Decorlimp">
                                    </div>
                                    <div class="text">
                                ...
                                <div class="single-contact-content d-flex align-items-center">
                                <div class="icon">
                                    <a href="https://api.whatsapp.com/send?phone=5511964891638&text=Quero%20solicitar%20o%20a%20servi%C3%A7o%20de%20voc%C3%AAs." target="_blank"  data-toggle="tooltip" data-placement="bottom" title="SOLICITE ORÇAMENTO VIA WHATSAPP" href="#"><img src="img/core-img/call.png" alt="Lavagem e Limpeza de Sofás e Estofados, ligue: 11 964891638 | Decorlimp"></a>
                                </div>
                                <div class="text">
                                    <a href="https://api.whatsapp.com/send?phone=5511964891638&text=Quero%20solicitar%20o%20a%20servi%C3%A7o%20de%20voc%C3%AAs." target="_blank" data-toggle="tooltip" data-placement="bottom" title="SOLICITE ORÇAMENTO VIA WHATSAPP" href="#"><p>(11) 96489-1638</p>
                                ...
                                <div class="single-contact-content d-flex align-items-center">
                                <div class="icon">
                                    <a href="mailto: comercial@decorlimp.com.br" data-toggle="tooltip" data-placement="bottom" title="SOLICITE ORÇAMENTO VIA E-MAIL" href="#"><img src="img/core-img/message2.png" alt="Lavagem e Limpeza de Sofás e Estofados, ligue: 11 964891638 | Decorlimp"></a>
                                </div>
                                <div class="text">
                                    <a href="mailto: comercial@decorlimp.com.br" data-toggle="tooltip" data-placement="bottom" title="SOLICITE ORÇAMENTO VIA E-MAIL" href="#"><p>comercial@decorlimp.com.br</p>
        ...
        <!-- ##### Google Maps ##### -->
        <div class="map-area">
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14619.887862434363!2d-46.668804!3d-23.641175!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa2ee4c54cdba4e98!2sDECORLIMP!5e0!3m2!1spt-BR!2sbr!4v1548382404298" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            <!-- Contact Area -->
